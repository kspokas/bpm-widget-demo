...
public class RevProxyServlet extends HttpServlet {
	...
	protected static final String ATTR_TARGET_URI = RevProxyServlet.class.getSimpleName() + ".targetUri";
	protected static final String ATTR_TARGET_HOST = RevProxyServlet.class.getSimpleName() + ".targetHost";
